...
<html class="htmlClass">
  <head>  
    ...
    <script type="text/javascript" src="index.js?170908"></script>
  </head>
  <body class="bodyClass">
    ...
    <div data-role="popup" id="POPUP-EDIT-GROUP" data-overlay-theme="b" data-dismissible="false" style="max-width:650px;">
      ...
      <div style="clear:both;text-align:right"><button onclick="save_inner_type()" class="ui-btn ui-btn-icon-left ui-corner-all ui-icon-save ui-btn-inline ui-btn-b"  id="product_type_save_button">Save Changes</button></div>
    </div>
    ...
    <div data-role="popup" id="POPUP-TOPUP" data-overlay-theme="b" data-dismissible="false" class="ui-content" rel=”external” style="position:fixed;top:20px;">
      ...
      <div class="INNER-FOOTER" style="clear:both;">
        <div style="margin:0 auto;width:180px">
          <button  id="topup-save-button" class="ui-btn ui-icon-check ui-btn-icon-left ui-btn-b ui-corner-all" onclick="topup_product()">Save</button>
        </div>
        <div style="clear:both;"></div>
      </div>
    </div>
    ...
    <div data-role="popup" id="POPUP-STOCK" data-overlay-theme="b" data-dismissible="false" class="ui-content" rel=”external” style="position:fixed;top:20px;">
      ...
      <div class="INNER-FOOTER" style="clear:both;">
        <div style="margin:0 auto;width:180px">
          <button  id="stock-save-button" class="ui-btn ui-icon-check ui-btn-icon-left ui-btn-b ui-corner-all" onclick="stock_product()">Save</button>
        </div>
        <div style="clear:both;"></div>
      </div>
    </div>
