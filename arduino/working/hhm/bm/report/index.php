...
include("../../admin/setting/fn_username.php");
include("../../admin/promotion/fn_promotion.php");
$Page_Name = 'Report';
$d = $_GET['d'];
$tab = $_GET['tab'];
$ord = $_GET['ord'];
...
<html>
  ...
  <body>
    ...
    <div id="sub-bar" style="padding:3px 5px;background-color:#000;">
      <div style="float:left;margin-left:60px;">
        <select id="tab" class="fs20" onChange="change_page(0)">
          ...
          <!--<option value='5_1'>5.1Stock Detail Report</option>-->
      ...
      <div style="float:right;margin-right:10px;" id="branch_work"></div>
    ...
    <div id="tab_result_area" style="clear:both;overflow-y:auto">asdf</div>
