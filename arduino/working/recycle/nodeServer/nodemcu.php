...
/*
    ...
    <body>
        <iframe src="http://192.168.1.54:8080/client1" ></iframe>
        <iframe src="http://192.168.1.51:81/stream" style="top:31%"></iframe></br>
        <div style="width:100%;padding:10px;">
            <div style='display:show;position:absolute;bottom:10px'>
            ...
            <table style="display:none;position:absolute;width:100%">
                <tr>
                    <td></td>
        ...
        <div style="position:absolute;left:50%;bottom:5px;width:100%" id="BTN-CONTROL">
