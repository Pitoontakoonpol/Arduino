...
<html class="htmlClass">
    ...
    <body>
	<iframe src="http://35.240.185.52/client1" height="500" width="700" ></iframe>
        <iframe src="http://34.87.71.163/client" height="500" width="700" ></iframe></br>
        <div style="width:100%;max-width:350px;padding:10px;">
            ...
            <table>
                <tr>
                    <td></td>
                    <td><button class='command-btn' cmd="TX1" style='font:bold 70px sans-serif'>↑</button></td>
                    <td></td>
                    <td rowspan="3" style="center:70px;"></td>
                </tr>
                <tr>
                    <td><button class='command-btn' cmd="TX3" style='font:bold 70px sans-serif'>←</button></td>
                    <td></td>
                    <td><button class='command-btn' cmd="TX4" style='font:bold 70px sans-serif'>→</button></td>
		    <td><button class='command-btn' cmd="TX5" style='font:bold 70px sans-serif'>Grab!</button></td>
                </tr>
                <tr>
                    <td></td>
                    <td><button class='command-btn' cmd="TX2" style='font:bold 70px sans-serif'>↓</button></td>
                    <td></td>
                </tr>
	</table>
        </div>
